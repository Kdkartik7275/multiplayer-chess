...
// Solid filled glyphs only — iOS Safari renders hollow glyphs (♔♕) as black outlines
// regardless of CSS color. Solid glyphs (♚♛) respect color: #fff correctly.
const GLYPHS = {
  K: "♚",
  Q: "♛",
  R: "♜",
...
function updateGameActButtons() {
  ...
  if (db) db.disabled = d || isVsComputer;
}
